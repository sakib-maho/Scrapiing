...
try:
    ...
    details = scraper.get_listing_details(test_url)
    
    if details.get("success"):
        print("\n✓ Listing scraped successfully")
        print(f"\nTitle: {details.get('title', 'N/A')[:80]}...")
        ...
        if details.get("phone"):
            ...
            print("\nThis means the phone extraction needs further investigation.")
    else:
